...
Автоматизация тестирования веб-приложения **[Трещотка](https://treshotka.vercel.app/)**. 
...
*   **Отчеты:** Playwright HTML Reporter.
...
Отчеты Playwright: После каждого прогона генерируется подробный HTML-отчет с шагами и скриншотами.
